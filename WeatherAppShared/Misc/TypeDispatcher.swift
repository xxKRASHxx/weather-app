...
public enum TypeDispatcher<ValueType> {
  case value(ValueType)
  
  @discardableResult public func dispatch<Subject>(_ closure: (Subject) -> Void) -> TypeDispatcher<ValueType> {
    switch self {
