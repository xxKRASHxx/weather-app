...
public struct AppLocation: Encodable, Equatable {
  
  public let availability: Availability; public enum Availability: String, Encodable, Equatable {
  ...
  public let deviceLocation: DeviceLocation; public enum DeviceLocation: AutoEncodable, Equatable {
    case none
    case updating
...
extension AppLocation: Defaultable {
  public static var defaultValue = AppLocation(
...
public func == (lhs: AppLocation.DeviceLocation, rhs: AppLocation.DeviceLocation) -> Bool {
  switch (lhs, rhs) {
